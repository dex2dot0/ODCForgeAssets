...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.Models.Connect_embedded_account_session_create_components? Components { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.Models.Connect_embedded_account_session_create_components Components { get; set; }
#endif
        ...
        public global::StripeKiota.Client.Models.Account_session_object? Object { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::StripeKiota.Client.Models.Account_session"/> and sets the default values.
        /// </summary>
        ...
        public static global::StripeKiota.Client.Models.Account_session CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.Models.Account_session();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "components", n => { Components = n.GetObjectValue<global::StripeKiota.Client.Models.Connect_embedded_account_session_create_components>(global::StripeKiota.Client.Models.Connect_embedded_account_session_create_components.CreateFromDiscriminatorValue); } },
                { "expires_at", n => { ExpiresAt = n.GetIntValue(); } },
                { "livemode", n => { Livemode = n.GetBoolValue(); } },
                { "object", n => { Object = n.GetEnumValue<global::StripeKiota.Client.Models.Account_session_object>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.Models.Connect_embedded_account_session_create_components>("components", Components);
            writer.WriteIntValue("expires_at", ExpiresAt);
            writer.WriteBoolValue("livemode", Livemode);
            writer.WriteEnumValue<global::StripeKiota.Client.Models.Account_session_object>("object", Object);
