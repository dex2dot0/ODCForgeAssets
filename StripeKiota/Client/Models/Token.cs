...
#nullable restore
        ...
        public global::StripeKiota.Client.Models.Token_object? Object { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::StripeKiota.Client.Models.Token"/> and sets the default values.
        /// </summary>
        public Token()
        {
        ...
        public static global::StripeKiota.Client.Models.Token CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.Models.Token();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "bank_account", n => { BankAccount = n.GetObjectValue<global::StripeKiota.Client.Models.Bank_account>(global::StripeKiota.Client.Models.Bank_account.CreateFromDiscriminatorValue); } },
                { "card", n => { Card = n.GetObjectValue<global::StripeKiota.Client.Models.Card>(global::StripeKiota.Client.Models.Card.CreateFromDiscriminatorValue); } },
                { "client_ip", n => { ClientIp = n.GetStringValue(); } },
                { "created", n => { Created = n.GetIntValue(); } },
                { "id", n => { Id = n.GetStringValue(); } },
                { "livemode", n => { Livemode = n.GetBoolValue(); } },
                { "object", n => { Object = n.GetEnumValue<global::StripeKiota.Client.Models.Token_object>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.Models.Bank_account>("bank_account", BankAccount);
            writer.WriteObjectValue<global::StripeKiota.Client.Models.Card>("card", Card);
            writer.WriteStringValue("client_ip", ClientIp);
            writer.WriteIntValue("created", Created);
            writer.WriteStringValue("id", Id);
            writer.WriteBoolValue("livemode", Livemode);
            writer.WriteEnumValue<global::StripeKiota.Client.Models.Token_object>("object", Object);
