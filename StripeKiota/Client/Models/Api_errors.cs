...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.Models.Api_errors.Api_errors_source? Source { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.Models.Api_errors.Api_errors_source Source { get; set; }
#endif
        /// <summary>The type of error returned. One of `api_error`, `card_error`, `idempotency_error`, or `invalid_request_error`</summary>
        public global::StripeKiota.Client.Models.Api_errors_type? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::StripeKiota.Client.Models.Api_errors"/> and sets the default values.
        /// </summary>
        public Api_errors()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.Models.Api_errors"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.Models.Api_errors CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.Models.Api_errors();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "payment_intent", n => { PaymentIntent = n.GetObjectValue<global::StripeKiota.Client.Models.Payment_intent>(global::StripeKiota.Client.Models.Payment_intent.CreateFromDiscriminatorValue); } },
                { "payment_method", n => { PaymentMethod = n.GetObjectValue<global::StripeKiota.Client.Models.Payment_method>(global::StripeKiota.Client.Models.Payment_method.CreateFromDiscriminatorValue); } },
                { "payment_method_type", n => { PaymentMethodType = n.GetStringValue(); } },
                { "request_log_url", n => { RequestLogUrl = n.GetStringValue(); } },
                { "setup_intent", n => { SetupIntent = n.GetObjectValue<global::StripeKiota.Client.Models.Setup_intent>(global::StripeKiota.Client.Models.Setup_intent.CreateFromDiscriminatorValue); } },
                { "source", n => { Source = n.GetObjectValue<global::StripeKiota.Client.Models.Api_errors.Api_errors_source>(global::StripeKiota.Client.Models.Api_errors.Api_errors_source.CreateFromDiscriminatorValue); } },
                { "type", n => { Type = n.GetEnumValue<global::StripeKiota.Client.Models.Api_errors_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.Models.Payment_intent>("payment_intent", PaymentIntent);
            writer.WriteObjectValue<global::StripeKiota.Client.Models.Payment_method>("payment_method", PaymentMethod);
            writer.WriteStringValue("payment_method_type", PaymentMethodType);
            writer.WriteStringValue("request_log_url", RequestLogUrl);
            writer.WriteObjectValue<global::StripeKiota.Client.Models.Setup_intent>("setup_intent", SetupIntent);
            writer.WriteObjectValue<global::StripeKiota.Client.Models.Api_errors.Api_errors_source>("source", Source);
            writer.WriteEnumValue<global::StripeKiota.Client.Models.Api_errors_type>("type", Type);
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::StripeKiota.Client.Models.Api_errors.Api_errors_source"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::StripeKiota.Client.Models.Api_errors.Api_errors_source CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::StripeKiota.Client.Models.Api_errors.Api_errors_source();
