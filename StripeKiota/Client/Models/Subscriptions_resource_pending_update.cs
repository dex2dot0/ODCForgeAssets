...
#nullable enable
        public List<global::StripeKiota.Client.Models.Subscription_item>? SubscriptionItems { get; set; }
#nullable restore
#else
        public List<global::StripeKiota.Client.Models.Subscription_item> SubscriptionItems { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::StripeKiota.Client.Models.Subscriptions_resource_pending_update"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.Models.Subscriptions_resource_pending_update"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.Models.Subscriptions_resource_pending_update CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.Models.Subscriptions_resource_pending_update();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "subscription_items", n => { SubscriptionItems = n.GetCollectionOfObjectValues<global::StripeKiota.Client.Models.Subscription_item>(global::StripeKiota.Client.Models.Subscription_item.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::StripeKiota.Client.Models.Subscription_item>("subscription_items", SubscriptionItems);
