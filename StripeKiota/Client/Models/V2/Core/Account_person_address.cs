...
namespace StripeKiota.Client.Models.V2.Core
{
    ...
    public partial class Account_person_address : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::StripeKiota.Client.Models.V2.Core.Account_person_address"/> and sets the default values.
        /// </summary>
        public Account_person_address()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.Models.V2.Core.Account_person_address"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.Models.V2.Core.Account_person_address CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.Models.V2.Core.Account_person_address();
        }
        /// <summary>
