...
namespace StripeKiota.Client.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::StripeKiota.Client.Models.Charge_outcome_advice_code? AdviceCode { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.Models.Charge_outcome.Charge_outcome_rule? Rule { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.Models.Charge_outcome.Charge_outcome_rule Rule { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::StripeKiota.Client.Models.Charge_outcome"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.Models.Charge_outcome"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.Models.Charge_outcome CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.Models.Charge_outcome();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "advice_code", n => { AdviceCode = n.GetEnumValue<global::StripeKiota.Client.Models.Charge_outcome_advice_code>(); } },
                ...
                { "rule", n => { Rule = n.GetObjectValue<global::StripeKiota.Client.Models.Charge_outcome.Charge_outcome_rule>(global::StripeKiota.Client.Models.Charge_outcome.Charge_outcome_rule.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::StripeKiota.Client.Models.Charge_outcome_advice_code>("advice_code", AdviceCode);
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.Models.Charge_outcome.Charge_outcome_rule>("rule", Rule);
            writer.WriteStringValue("seller_message", SellerMessage);
            writer.WriteStringValue("type", Type);
            writer.WriteAdditionalData(AdditionalData);
        }
        /// <summary>
        /// Composed type wrapper for classes <see cref="global::StripeKiota.Client.Models.Rule"/>, <see cref="string"/>
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Charge_outcome_rule : IComposedTypeWrapper, IParsable
        {
            /// <summary>Composed type representation for type <see cref="global::StripeKiota.Client.Models.Rule"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::StripeKiota.Client.Models.Rule? Rule { get; set; }
#nullable restore
#else
            public global::StripeKiota.Client.Models.Rule Rule { get; set; }
#endif
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::StripeKiota.Client.Models.Charge_outcome.Charge_outcome_rule"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::StripeKiota.Client.Models.Charge_outcome.Charge_outcome_rule CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::StripeKiota.Client.Models.Charge_outcome.Charge_outcome_rule();
                if(parseNode.GetStringValue() is string stringValue)
                {
                    result.String = stringValue;
                }
                else {
                    result.Rule = new global::StripeKiota.Client.Models.Rule();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer)
            {
                ...
                if(String != null)
                {
                    ...
                    writer.WriteObjectValue<global::StripeKiota.Client.Models.Rule>(null, Rule);
                }
            }
        }
    }
