...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.Models.Tax_rate_flat_amount? FlatAmount { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.Models.Tax_rate_flat_amount FlatAmount { get; set; }
#endif
...
#nullable restore
        ...
        public global::StripeKiota.Client.Models.Tax_rate_jurisdiction_level? JurisdictionLevel { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.Models.Tax_rate_metadata? Metadata { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.Models.Tax_rate_metadata Metadata { get; set; }
#endif
        /// <summary>String representing the object&apos;s type. Objects of the same type share the same value.</summary>
        public global::StripeKiota.Client.Models.Tax_rate_object? Object { get; set; }
        ...
        public global::StripeKiota.Client.Models.Tax_rate_rate_type? RateType { get; set; }
...
#nullable restore
        ...
        public global::StripeKiota.Client.Models.Tax_rate_tax_type? TaxType { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::StripeKiota.Client.Models.Tax_rate"/> and sets the default values.
        /// </summary>
        public Tax_rate()
        {
        ...
        public static global::StripeKiota.Client.Models.Tax_rate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.Models.Tax_rate();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "flat_amount", n => { FlatAmount = n.GetObjectValue<global::StripeKiota.Client.Models.Tax_rate_flat_amount>(global::StripeKiota.Client.Models.Tax_rate_flat_amount.CreateFromDiscriminatorValue); } },
                { "id", n => { Id = n.GetStringValue(); } },
                { "inclusive", n => { Inclusive = n.GetBoolValue(); } },
                { "jurisdiction", n => { Jurisdiction = n.GetStringValue(); } },
                { "jurisdiction_level", n => { JurisdictionLevel = n.GetEnumValue<global::StripeKiota.Client.Models.Tax_rate_jurisdiction_level>(); } },
                { "livemode", n => { Livemode = n.GetBoolValue(); } },
                { "metadata", n => { Metadata = n.GetObjectValue<global::StripeKiota.Client.Models.Tax_rate_metadata>(global::StripeKiota.Client.Models.Tax_rate_metadata.CreateFromDiscriminatorValue); } },
                { "object", n => { Object = n.GetEnumValue<global::StripeKiota.Client.Models.Tax_rate_object>(); } },
                { "percentage", n => { Percentage = n.GetDoubleValue(); } },
                { "rate_type", n => { RateType = n.GetEnumValue<global::StripeKiota.Client.Models.Tax_rate_rate_type>(); } },
                { "state", n => { State = n.GetStringValue(); } },
                { "tax_type", n => { TaxType = n.GetEnumValue<global::StripeKiota.Client.Models.Tax_rate_tax_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.Models.Tax_rate_flat_amount>("flat_amount", FlatAmount);
            writer.WriteStringValue("id", Id);
            writer.WriteBoolValue("inclusive", Inclusive);
            writer.WriteStringValue("jurisdiction", Jurisdiction);
            writer.WriteEnumValue<global::StripeKiota.Client.Models.Tax_rate_jurisdiction_level>("jurisdiction_level", JurisdictionLevel);
            writer.WriteBoolValue("livemode", Livemode);
            writer.WriteObjectValue<global::StripeKiota.Client.Models.Tax_rate_metadata>("metadata", Metadata);
            writer.WriteEnumValue<global::StripeKiota.Client.Models.Tax_rate_object>("object", Object);
            writer.WriteDoubleValue("percentage", Percentage);
            writer.WriteEnumValue<global::StripeKiota.Client.Models.Tax_rate_rate_type>("rate_type", RateType);
            writer.WriteStringValue("state", State);
            writer.WriteEnumValue<global::StripeKiota.Client.Models.Tax_rate_tax_type>("tax_type", TaxType);
