...
#nullable restore
        ...
        public global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody_account_holder_type? AccountHolderType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody_owner? Owner { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody_owner Owner { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "account_holder_type", n => { AccountHolderType = n.GetEnumValue<global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody_account_holder_type>(); } },
                ...
                { "owner", n => { Owner = n.GetObjectValue<global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody_owner>(global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody_owner.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody_account_holder_type>("account_holder_type", AccountHolderType);
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.V1.Customers.Item.Sources.Item.SourcesPostRequestBody_owner>("owner", Owner);
        }
    }
}
