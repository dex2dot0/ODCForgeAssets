...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.V1.Plans.Item.WithPlanPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.V1.Plans.Item.WithPlanPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.V1.Plans.Item.WithPlanPostRequestBody();
        }
        /// <summary>
