...
#nullable enable
        public global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_applies_to? AppliesTo { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_applies_to AppliesTo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_currency_options? CurrencyOptions { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_currency_options CurrencyOptions { get; set; }
#endif
        /// <summary>Specifies how long the discount will be in effect if used on a subscription. Defaults to `once`.</summary>
        public global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_duration? Duration { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "applies_to", n => { AppliesTo = n.GetObjectValue<global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_applies_to>(global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_applies_to.CreateFromDiscriminatorValue); } },
                { "currency", n => { Currency = n.GetStringValue(); } },
                { "currency_options", n => { CurrencyOptions = n.GetObjectValue<global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_currency_options>(global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_currency_options.CreateFromDiscriminatorValue); } },
                { "duration", n => { Duration = n.GetEnumValue<global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_duration>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_applies_to>("applies_to", AppliesTo);
            writer.WriteStringValue("currency", Currency);
            writer.WriteObjectValue<global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_currency_options>("currency_options", CurrencyOptions);
            writer.WriteEnumValue<global::StripeKiota.Client.V1.Coupons.CouponsPostRequestBody_duration>("duration", Duration);
