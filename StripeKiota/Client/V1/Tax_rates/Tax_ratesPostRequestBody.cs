...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody_metadata? Metadata { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody_metadata Metadata { get; set; }
#endif
...
#nullable restore
        ...
        public global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody_tax_type? TaxType { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metadata", n => { Metadata = n.GetObjectValue<global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody_metadata>(global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody_metadata.CreateFromDiscriminatorValue); } },
                { "percentage", n => { Percentage = n.GetDoubleValue(); } },
                { "state", n => { State = n.GetStringValue(); } },
                { "tax_type", n => { TaxType = n.GetEnumValue<global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody_tax_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody_metadata>("metadata", Metadata);
            writer.WriteDoubleValue("percentage", Percentage);
            writer.WriteStringValue("state", State);
            writer.WriteEnumValue<global::StripeKiota.Client.V1.Tax_rates.Tax_ratesPostRequestBody_tax_type>("tax_type", TaxType);
        }
    }
}
