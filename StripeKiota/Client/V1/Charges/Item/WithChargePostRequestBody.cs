...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody_fraud_details? FraudDetails { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody_fraud_details FraudDetails { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody_shipping? Shipping { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody_shipping Shipping { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "fraud_details", n => { FraudDetails = n.GetObjectValue<global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody_fraud_details>(global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody_fraud_details.CreateFromDiscriminatorValue); } },
                { "metadata", n => { Metadata = n.GetStringValue(); } },
                { "receipt_email", n => { ReceiptEmail = n.GetStringValue(); } },
                { "shipping", n => { Shipping = n.GetObjectValue<global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody_shipping>(global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody_shipping.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody_fraud_details>("fraud_details", FraudDetails);
            writer.WriteStringValue("metadata", Metadata);
            writer.WriteStringValue("receipt_email", ReceiptEmail);
            writer.WriteObjectValue<global::StripeKiota.Client.V1.Charges.Item.WithChargePostRequestBody_shipping>("shipping", Shipping);
