...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody_flow_data? FlowData { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody_flow_data FlowData { get; set; }
#endif
        ...
        public global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody_locale? Locale { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "flow_data", n => { FlowData = n.GetObjectValue<global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody_flow_data>(global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody_flow_data.CreateFromDiscriminatorValue); } },
                { "locale", n => { Locale = n.GetEnumValue<global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody_locale>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody_flow_data>("flow_data", FlowData);
            writer.WriteEnumValue<global::StripeKiota.Client.V1.Billing_portal.Sessions.SessionsPostRequestBody_locale>("locale", Locale);
