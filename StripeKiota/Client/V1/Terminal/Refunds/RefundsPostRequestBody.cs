...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody_metadata? Metadata { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody_metadata Metadata { get; set; }
#endif
...
#nullable restore
        ...
        public global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody_reason? Reason { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metadata", n => { Metadata = n.GetObjectValue<global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody_metadata>(global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody_metadata.CreateFromDiscriminatorValue); } },
                { "payment_intent", n => { PaymentIntent = n.GetStringValue(); } },
                { "reason", n => { Reason = n.GetEnumValue<global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody_reason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody_metadata>("metadata", Metadata);
            writer.WriteStringValue("payment_intent", PaymentIntent);
            writer.WriteEnumValue<global::StripeKiota.Client.V1.Terminal.Refunds.RefundsPostRequestBody_reason>("reason", Reason);
