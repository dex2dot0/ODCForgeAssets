...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody.PayPostRequestBody_mandate? Mandate { get; set; }
#nullable restore
#else
        public global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody.PayPostRequestBody_mandate Mandate { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "mandate", n => { Mandate = n.GetObjectValue<global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody.PayPostRequestBody_mandate>(global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody.PayPostRequestBody_mandate.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody.PayPostRequestBody_mandate>("mandate", Mandate);
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody.PayPostRequestBody_mandate"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody.PayPostRequestBody_mandate CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::StripeKiota.Client.V1.Invoices.Item.Pay.PayPostRequestBody.PayPostRequestBody_mandate();
