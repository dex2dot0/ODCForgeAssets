...
namespace StripeKiota.Client.V1.Payment_intents.Item.Confirm
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::StripeKiota.Client.V1.Payment_intents.Item.Confirm.ConfirmRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::StripeKiota.Client.Models.Payment_intent?> PostAsync(global::StripeKiota.Client.V1.Payment_intents.Item.Confirm.ConfirmPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::StripeKiota.Client.Models.Payment_intent> PostAsync(global::StripeKiota.Client.V1.Payment_intents.Item.Confirm.ConfirmPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::StripeKiota.Client.V1.Payment_intents.Item.Confirm.ConfirmPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::StripeKiota.Client.V1.Payment_intents.Item.Confirm.ConfirmPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::StripeKiota.Client.V1.Payment_intents.Item.Confirm.ConfirmRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::StripeKiota.Client.V1.Payment_intents.Item.Confirm.ConfirmRequestBuilder WithUrl(string rawUrl)
        {
            return new global::StripeKiota.Client.V1.Payment_intents.Item.Confirm.ConfirmRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
