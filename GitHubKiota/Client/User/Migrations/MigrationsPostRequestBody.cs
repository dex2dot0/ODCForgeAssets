...
#nullable enable
        public List<global::GitHubKiota.Client.User.Migrations.MigrationsPostRequestBody_exclude?>? Exclude { get; set; }
#nullable restore
#else
        public List<global::GitHubKiota.Client.User.Migrations.MigrationsPostRequestBody_exclude?> Exclude { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.User.Migrations.MigrationsPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.User.Migrations.MigrationsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.User.Migrations.MigrationsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.User.Migrations.MigrationsPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "exclude", n => { Exclude = n.GetCollectionOfEnumValues<global::GitHubKiota.Client.User.Migrations.MigrationsPostRequestBody_exclude>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::GitHubKiota.Client.User.Migrations.MigrationsPostRequestBody_exclude>("exclude", Exclude);
