...
#nullable restore
        ...
        public global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_merge_commit_message? MergeCommitMessage { get; set; }
        ...
        public global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_merge_commit_title? MergeCommitTitle { get; set; }
...
#nullable restore
        ...
        public global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_squash_merge_commit_message? SquashMergeCommitMessage { get; set; }
        ...
        public global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_squash_merge_commit_title? SquashMergeCommitTitle { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.User.Repos.ReposPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.User.Repos.ReposPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.User.Repos.ReposPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.User.Repos.ReposPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "merge_commit_message", n => { MergeCommitMessage = n.GetEnumValue<global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_merge_commit_message>(); } },
                { "merge_commit_title", n => { MergeCommitTitle = n.GetEnumValue<global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_merge_commit_title>(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "private", n => { Private = n.GetBoolValue(); } },
                { "squash_merge_commit_message", n => { SquashMergeCommitMessage = n.GetEnumValue<global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_squash_merge_commit_message>(); } },
                { "squash_merge_commit_title", n => { SquashMergeCommitTitle = n.GetEnumValue<global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_squash_merge_commit_title>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_merge_commit_message>("merge_commit_message", MergeCommitMessage);
            writer.WriteEnumValue<global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_merge_commit_title>("merge_commit_title", MergeCommitTitle);
            writer.WriteStringValue("name", Name);
            writer.WriteBoolValue("private", Private);
            writer.WriteEnumValue<global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_squash_merge_commit_message>("squash_merge_commit_message", SquashMergeCommitMessage);
            writer.WriteEnumValue<global::GitHubKiota.Client.User.Repos.ReposPostRequestBody_squash_merge_commit_title>("squash_merge_commit_title", SquashMergeCommitTitle);
