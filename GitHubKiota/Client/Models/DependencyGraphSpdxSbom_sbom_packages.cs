...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHubKiota.Client.Models.DependencyGraphSpdxSbom_sbom_packages_externalRefs>? ExternalRefs { get; set; }
#nullable restore
#else
        public List<global::GitHubKiota.Client.Models.DependencyGraphSpdxSbom_sbom_packages_externalRefs> ExternalRefs { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.DependencyGraphSpdxSbom_sbom_packages"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Models.DependencyGraphSpdxSbom_sbom_packages"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Models.DependencyGraphSpdxSbom_sbom_packages CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.DependencyGraphSpdxSbom_sbom_packages();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "externalRefs", n => { ExternalRefs = n.GetCollectionOfObjectValues<global::GitHubKiota.Client.Models.DependencyGraphSpdxSbom_sbom_packages_externalRefs>(global::GitHubKiota.Client.Models.DependencyGraphSpdxSbom_sbom_packages_externalRefs.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::GitHubKiota.Client.Models.DependencyGraphSpdxSbom_sbom_packages_externalRefs>("externalRefs", ExternalRefs);
