...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.Codespace_git_status? GitStatus { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.Codespace_git_status GitStatus { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.Codespace_location? Location { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.MinimalRepository? Repository { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.MinimalRepository Repository { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.Codespace_runtime_constraints? RuntimeConstraints { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.Codespace_runtime_constraints RuntimeConstraints { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.Codespace_state? State { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.Codespace"/> and sets the default values.
        /// </summary>
        public Codespace()
        {
        ...
        public static global::GitHubKiota.Client.Models.Codespace CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.Codespace();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "git_status", n => { GitStatus = n.GetObjectValue<global::GitHubKiota.Client.Models.Codespace_git_status>(global::GitHubKiota.Client.Models.Codespace_git_status.CreateFromDiscriminatorValue); } },
                ...
                { "location", n => { Location = n.GetEnumValue<global::GitHubKiota.Client.Models.Codespace_location>(); } },
                ...
                { "repository", n => { Repository = n.GetObjectValue<global::GitHubKiota.Client.Models.MinimalRepository>(global::GitHubKiota.Client.Models.MinimalRepository.CreateFromDiscriminatorValue); } },
                ...
                { "runtime_constraints", n => { RuntimeConstraints = n.GetObjectValue<global::GitHubKiota.Client.Models.Codespace_runtime_constraints>(global::GitHubKiota.Client.Models.Codespace_runtime_constraints.CreateFromDiscriminatorValue); } },
                { "start_url", n => { StartUrl = n.GetStringValue(); } },
                { "state", n => { State = n.GetEnumValue<global::GitHubKiota.Client.Models.Codespace_state>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.Codespace_git_status>("git_status", GitStatus);
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.Codespace_location>("location", Location);
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.MinimalRepository>("repository", Repository);
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.Codespace_runtime_constraints>("runtime_constraints", RuntimeConstraints);
            writer.WriteStringValue("start_url", StartUrl);
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.Codespace_state>("state", State);
