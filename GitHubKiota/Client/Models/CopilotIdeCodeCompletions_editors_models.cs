...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHubKiota.Client.Models.CopilotIdeCodeCompletions_editors_models_languages>? Languages { get; set; }
#nullable restore
#else
        public List<global::GitHubKiota.Client.Models.CopilotIdeCodeCompletions_editors_models_languages> Languages { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.CopilotIdeCodeCompletions_editors_models"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Models.CopilotIdeCodeCompletions_editors_models"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Models.CopilotIdeCodeCompletions_editors_models CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.CopilotIdeCodeCompletions_editors_models();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "languages", n => { Languages = n.GetCollectionOfObjectValues<global::GitHubKiota.Client.Models.CopilotIdeCodeCompletions_editors_models_languages>(global::GitHubKiota.Client.Models.CopilotIdeCodeCompletions_editors_models_languages.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::GitHubKiota.Client.Models.CopilotIdeCodeCompletions_editors_models_languages>("languages", Languages);
