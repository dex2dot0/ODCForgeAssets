...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.PullRequestReviewComment_links? Links { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.PullRequestReviewComment_links Links { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.PullRequestReviewComment_side? Side { get; set; }
        /// <summary>The first line of the range for a multi-line comment.</summary>
        public int? StartLine { get; set; }
        /// <summary>The side of the first line of the range for a multi-line comment.</summary>
        public global::GitHubKiota.Client.Models.PullRequestReviewComment_start_side? StartSide { get; set; }
        /// <summary>The level at which the comment is targeted, can be a diff line or a file.</summary>
        public global::GitHubKiota.Client.Models.PullRequestReviewComment_subject_type? SubjectType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.PullRequestReviewComment"/> and sets the default values.
        /// </summary>
        public PullRequestReviewComment()
        {
            AdditionalData = new Dictionary<string, object>();
            Side = global::GitHubKiota.Client.Models.PullRequestReviewComment_side.RIGHT;
            StartSide = global::GitHubKiota.Client.Models.PullRequestReviewComment_start_side.RIGHT;
        }
        /// <summary>
        ...
        public static global::GitHubKiota.Client.Models.PullRequestReviewComment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.PullRequestReviewComment();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "_links", n => { Links = n.GetObjectValue<global::GitHubKiota.Client.Models.PullRequestReviewComment_links>(global::GitHubKiota.Client.Models.PullRequestReviewComment_links.CreateFromDiscriminatorValue); } },
                ...
                { "side", n => { Side = n.GetEnumValue<global::GitHubKiota.Client.Models.PullRequestReviewComment_side>(); } },
                { "start_line", n => { StartLine = n.GetIntValue(); } },
                { "start_side", n => { StartSide = n.GetEnumValue<global::GitHubKiota.Client.Models.PullRequestReviewComment_start_side>(); } },
                { "subject_type", n => { SubjectType = n.GetEnumValue<global::GitHubKiota.Client.Models.PullRequestReviewComment_subject_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.PullRequestReviewComment_links>("_links", Links);
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.PullRequestReviewComment_side>("side", Side);
            writer.WriteIntValue("start_line", StartLine);
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.PullRequestReviewComment_start_side>("start_side", StartSide);
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.PullRequestReviewComment_subject_type>("subject_type", SubjectType);
