...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.Artifact_workflow_run? WorkflowRun { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.Artifact_workflow_run WorkflowRun { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.Artifact"/> and sets the default values.
        /// </summary>
        public Artifact()
        {
        ...
        public static global::GitHubKiota.Client.Models.Artifact CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.Artifact();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "workflow_run", n => { WorkflowRun = n.GetObjectValue<global::GitHubKiota.Client.Models.Artifact_workflow_run>(global::GitHubKiota.Client.Models.Artifact_workflow_run.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.Artifact_workflow_run>("workflow_run", WorkflowRun);
