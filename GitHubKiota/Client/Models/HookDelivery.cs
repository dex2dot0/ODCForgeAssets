...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.HookDelivery_request? Request { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.HookDelivery_request Request { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.HookDelivery_response? Response { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.HookDelivery_response Response { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.HookDelivery"/> and sets the default values.
        /// </summary>
        public HookDelivery()
        {
        ...
        public static global::GitHubKiota.Client.Models.HookDelivery CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.HookDelivery();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "request", n => { Request = n.GetObjectValue<global::GitHubKiota.Client.Models.HookDelivery_request>(global::GitHubKiota.Client.Models.HookDelivery_request.CreateFromDiscriminatorValue); } },
                { "response", n => { Response = n.GetObjectValue<global::GitHubKiota.Client.Models.HookDelivery_response>(global::GitHubKiota.Client.Models.HookDelivery_response.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.HookDelivery_request>("request", Request);
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.HookDelivery_response>("response", Response);
