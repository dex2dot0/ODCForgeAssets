...
#nullable enable
        public List<global::GitHubKiota.Client.Models.GpgKey_emails>? Emails { get; set; }
#nullable restore
#else
        public List<global::GitHubKiota.Client.Models.GpgKey_emails> Emails { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHubKiota.Client.Models.GpgKey_subkeys>? Subkeys { get; set; }
#nullable restore
#else
        public List<global::GitHubKiota.Client.Models.GpgKey_subkeys> Subkeys { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.GpgKey"/> and sets the default values.
        /// </summary>
        public GpgKey()
        {
        ...
        public static global::GitHubKiota.Client.Models.GpgKey CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.GpgKey();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "emails", n => { Emails = n.GetCollectionOfObjectValues<global::GitHubKiota.Client.Models.GpgKey_emails>(global::GitHubKiota.Client.Models.GpgKey_emails.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "subkeys", n => { Subkeys = n.GetCollectionOfObjectValues<global::GitHubKiota.Client.Models.GpgKey_subkeys>(global::GitHubKiota.Client.Models.GpgKey_subkeys.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::GitHubKiota.Client.Models.GpgKey_emails>("emails", Emails);
            ...
            writer.WriteCollectionOfObjectValues<global::GitHubKiota.Client.Models.GpgKey_subkeys>("subkeys", Subkeys);
