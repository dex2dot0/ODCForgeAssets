...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.Team_permissions? Permissions { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.Team_permissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.Team_type? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.Team"/> and sets the default values.
        /// </summary>
        public Team()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Models.Team"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Models.Team CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.Team();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "permissions", n => { Permissions = n.GetObjectValue<global::GitHubKiota.Client.Models.Team_permissions>(global::GitHubKiota.Client.Models.Team_permissions.CreateFromDiscriminatorValue); } },
                { "privacy", n => { Privacy = n.GetStringValue(); } },
                { "repositories_url", n => { RepositoriesUrl = n.GetStringValue(); } },
                { "slug", n => { Slug = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::GitHubKiota.Client.Models.Team_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.Team_permissions>("permissions", Permissions);
            writer.WriteStringValue("privacy", Privacy);
            writer.WriteStringValue("repositories_url", RepositoriesUrl);
            writer.WriteStringValue("slug", Slug);
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.Team_type>("type", Type);
