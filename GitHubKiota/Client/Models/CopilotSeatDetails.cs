...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.CopilotSeatDetails_assigning_team? AssigningTeam { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.CopilotSeatDetails_assigning_team AssigningTeam { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.CopilotSeatDetails_plan_type? PlanType { get; set; }
        ...
        public static global::GitHubKiota.Client.Models.CopilotSeatDetails CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.CopilotSeatDetails();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "assigning_team", n => { AssigningTeam = n.GetObjectValue<global::GitHubKiota.Client.Models.CopilotSeatDetails_assigning_team>(global::GitHubKiota.Client.Models.CopilotSeatDetails_assigning_team.CreateFromDiscriminatorValue); } },
                ...
                { "plan_type", n => { PlanType = n.GetEnumValue<global::GitHubKiota.Client.Models.CopilotSeatDetails_plan_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.CopilotSeatDetails_assigning_team>("assigning_team", AssigningTeam);
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.CopilotSeatDetails_plan_type>("plan_type", PlanType);
