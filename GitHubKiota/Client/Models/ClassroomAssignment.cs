...
#nullable enable
        public global::GitHubKiota.Client.Models.Classroom? Classroom { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.Classroom Classroom { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.SimpleClassroomRepository? StarterCodeRepository { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.SimpleClassroomRepository StarterCodeRepository { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.ClassroomAssignment_type? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.ClassroomAssignment"/> and sets the default values.
        /// </summary>
        ...
        public static global::GitHubKiota.Client.Models.ClassroomAssignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.ClassroomAssignment();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "classroom", n => { Classroom = n.GetObjectValue<global::GitHubKiota.Client.Models.Classroom>(global::GitHubKiota.Client.Models.Classroom.CreateFromDiscriminatorValue); } },
                ...
                { "starter_code_repository", n => { StarterCodeRepository = n.GetObjectValue<global::GitHubKiota.Client.Models.SimpleClassroomRepository>(global::GitHubKiota.Client.Models.SimpleClassroomRepository.CreateFromDiscriminatorValue); } },
                { "students_are_repo_admins", n => { StudentsAreRepoAdmins = n.GetBoolValue(); } },
                { "submitted", n => { Submitted = n.GetIntValue(); } },
                { "title", n => { Title = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::GitHubKiota.Client.Models.ClassroomAssignment_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.Classroom>("classroom", Classroom);
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.SimpleClassroomRepository>("starter_code_repository", StarterCodeRepository);
            writer.WriteBoolValue("students_are_repo_admins", StudentsAreRepoAdmins);
            writer.WriteIntValue("submitted", Submitted);
            writer.WriteStringValue("title", Title);
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.ClassroomAssignment_type>("type", Type);
