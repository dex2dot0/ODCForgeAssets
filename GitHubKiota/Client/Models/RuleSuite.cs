...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.RuleSuite_evaluation_result? EvaluationResult { get; set; }
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.RuleSuite_result? Result { get; set; }
        /// <summary>Details on the evaluated rules.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHubKiota.Client.Models.RuleSuite_rule_evaluations>? RuleEvaluations { get; set; }
#nullable restore
#else
        public List<global::GitHubKiota.Client.Models.RuleSuite_rule_evaluations> RuleEvaluations { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.RuleSuite"/> and sets the default values.
        /// </summary>
        public RuleSuite()
        {
        ...
        public static global::GitHubKiota.Client.Models.RuleSuite CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.RuleSuite();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "evaluation_result", n => { EvaluationResult = n.GetEnumValue<global::GitHubKiota.Client.Models.RuleSuite_evaluation_result>(); } },
                ...
                { "result", n => { Result = n.GetEnumValue<global::GitHubKiota.Client.Models.RuleSuite_result>(); } },
                { "rule_evaluations", n => { RuleEvaluations = n.GetCollectionOfObjectValues<global::GitHubKiota.Client.Models.RuleSuite_rule_evaluations>(global::GitHubKiota.Client.Models.RuleSuite_rule_evaluations.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.RuleSuite_evaluation_result>("evaluation_result", EvaluationResult);
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.RuleSuite_result>("result", Result);
            writer.WriteCollectionOfObjectValues<global::GitHubKiota.Client.Models.RuleSuite_rule_evaluations>("rule_evaluations", RuleEvaluations);
