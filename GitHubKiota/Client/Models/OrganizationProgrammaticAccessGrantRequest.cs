...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest_permissions? Permissions { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest_permissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest_repository_selection? RepositorySelection { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "permissions", n => { Permissions = n.GetObjectValue<global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest_permissions>(global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest_permissions.CreateFromDiscriminatorValue); } },
                { "reason", n => { Reason = n.GetStringValue(); } },
                { "repositories_url", n => { RepositoriesUrl = n.GetStringValue(); } },
                { "repository_selection", n => { RepositorySelection = n.GetEnumValue<global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest_repository_selection>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest_permissions>("permissions", Permissions);
            writer.WriteStringValue("reason", Reason);
            writer.WriteStringValue("repositories_url", RepositoriesUrl);
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.OrganizationProgrammaticAccessGrantRequest_repository_selection>("repository_selection", RepositorySelection);
