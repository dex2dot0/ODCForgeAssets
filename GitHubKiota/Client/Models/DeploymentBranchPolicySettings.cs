...
namespace GitHubKiota.Client.Models
{
    ...
    public partial class DeploymentBranchPolicySettings : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.DeploymentBranchPolicySettings"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Models.DeploymentBranchPolicySettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Models.DeploymentBranchPolicySettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.DeploymentBranchPolicySettings();
        }
        /// <summary>
