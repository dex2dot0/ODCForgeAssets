...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.Installation_account? Account { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.Installation_account Account { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.AppPermissions? Permissions { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.AppPermissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.Installation_repository_selection? RepositorySelection { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.SimpleUser? SuspendedBy { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.SimpleUser SuspendedBy { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.Installation"/> and sets the default values.
        /// </summary>
        public Installation()
        {
        ...
        public static global::GitHubKiota.Client.Models.Installation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.Installation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "account", n => { Account = n.GetObjectValue<global::GitHubKiota.Client.Models.Installation_account>(global::GitHubKiota.Client.Models.Installation_account.CreateFromDiscriminatorValue); } },
                ...
                { "permissions", n => { Permissions = n.GetObjectValue<global::GitHubKiota.Client.Models.AppPermissions>(global::GitHubKiota.Client.Models.AppPermissions.CreateFromDiscriminatorValue); } },
                { "repositories_url", n => { RepositoriesUrl = n.GetStringValue(); } },
                { "repository_selection", n => { RepositorySelection = n.GetEnumValue<global::GitHubKiota.Client.Models.Installation_repository_selection>(); } },
                ...
                { "suspended_by", n => { SuspendedBy = n.GetObjectValue<global::GitHubKiota.Client.Models.SimpleUser>(global::GitHubKiota.Client.Models.SimpleUser.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.Installation_account>("account", Account);
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.AppPermissions>("permissions", Permissions);
            writer.WriteStringValue("repositories_url", RepositoriesUrl);
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.Installation_repository_selection>("repository_selection", RepositorySelection);
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.SimpleUser>("suspended_by", SuspendedBy);
