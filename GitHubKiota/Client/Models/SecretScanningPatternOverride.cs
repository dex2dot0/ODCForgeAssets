...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.SecretScanningPatternOverride_default_setting? DefaultSetting { get; set; }
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.SecretScanningPatternOverride_enterprise_setting? EnterpriseSetting { get; set; }
        ...
        public global::GitHubKiota.Client.Models.SecretScanningPatternOverride_setting? Setting { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.SecretScanningPatternOverride"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Models.SecretScanningPatternOverride"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Models.SecretScanningPatternOverride CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.SecretScanningPatternOverride();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "default_setting", n => { DefaultSetting = n.GetEnumValue<global::GitHubKiota.Client.Models.SecretScanningPatternOverride_default_setting>(); } },
                { "display_name", n => { DisplayName = n.GetStringValue(); } },
                { "enterprise_setting", n => { EnterpriseSetting = n.GetEnumValue<global::GitHubKiota.Client.Models.SecretScanningPatternOverride_enterprise_setting>(); } },
                { "false_positive_rate", n => { FalsePositiveRate = n.GetIntValue(); } },
                { "false_positives", n => { FalsePositives = n.GetIntValue(); } },
                { "setting", n => { Setting = n.GetEnumValue<global::GitHubKiota.Client.Models.SecretScanningPatternOverride_setting>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.SecretScanningPatternOverride_default_setting>("default_setting", DefaultSetting);
            writer.WriteStringValue("display_name", DisplayName);
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.SecretScanningPatternOverride_enterprise_setting>("enterprise_setting", EnterpriseSetting);
            writer.WriteIntValue("false_positive_rate", FalsePositiveRate);
            writer.WriteIntValue("false_positives", FalsePositives);
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.SecretScanningPatternOverride_setting>("setting", Setting);
