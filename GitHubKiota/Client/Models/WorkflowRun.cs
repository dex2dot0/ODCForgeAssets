...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.SimpleCommit? HeadCommit { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.SimpleCommit HeadCommit { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.MinimalRepository? HeadRepository { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.MinimalRepository HeadRepository { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHubKiota.Client.Models.PullRequestMinimal>? PullRequests { get; set; }
#nullable restore
#else
        public List<global::GitHubKiota.Client.Models.PullRequestMinimal> PullRequests { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHubKiota.Client.Models.ReferencedWorkflow>? ReferencedWorkflows { get; set; }
#nullable restore
#else
        public List<global::GitHubKiota.Client.Models.ReferencedWorkflow> ReferencedWorkflows { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Models.SimpleUser? TriggeringActor { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Models.SimpleUser TriggeringActor { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.WorkflowRun"/> and sets the default values.
        /// </summary>
        public WorkflowRun()
        {
        ...
        public static global::GitHubKiota.Client.Models.WorkflowRun CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.WorkflowRun();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "head_commit", n => { HeadCommit = n.GetObjectValue<global::GitHubKiota.Client.Models.SimpleCommit>(global::GitHubKiota.Client.Models.SimpleCommit.CreateFromDiscriminatorValue); } },
                { "head_repository", n => { HeadRepository = n.GetObjectValue<global::GitHubKiota.Client.Models.MinimalRepository>(global::GitHubKiota.Client.Models.MinimalRepository.CreateFromDiscriminatorValue); } },
                ...
                { "pull_requests", n => { PullRequests = n.GetCollectionOfObjectValues<global::GitHubKiota.Client.Models.PullRequestMinimal>(global::GitHubKiota.Client.Models.PullRequestMinimal.CreateFromDiscriminatorValue)?.AsList(); } },
                { "referenced_workflows", n => { ReferencedWorkflows = n.GetCollectionOfObjectValues<global::GitHubKiota.Client.Models.ReferencedWorkflow>(global::GitHubKiota.Client.Models.ReferencedWorkflow.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "triggering_actor", n => { TriggeringActor = n.GetObjectValue<global::GitHubKiota.Client.Models.SimpleUser>(global::GitHubKiota.Client.Models.SimpleUser.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.SimpleCommit>("head_commit", HeadCommit);
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.MinimalRepository>("head_repository", HeadRepository);
            ...
            writer.WriteCollectionOfObjectValues<global::GitHubKiota.Client.Models.PullRequestMinimal>("pull_requests", PullRequests);
            writer.WriteCollectionOfObjectValues<global::GitHubKiota.Client.Models.ReferencedWorkflow>("referenced_workflows", ReferencedWorkflows);
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Models.SimpleUser>("triggering_actor", TriggeringActor);
