...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHubKiota.Client.Models.Import_project_choices>? ProjectChoices { get; set; }
#nullable restore
#else
        public List<global::GitHubKiota.Client.Models.Import_project_choices> ProjectChoices { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.Import_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.Import"/> and sets the default values.
        /// </summary>
        public Import()
        {
        ...
        public static global::GitHubKiota.Client.Models.Import CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.Import();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "project_choices", n => { ProjectChoices = n.GetCollectionOfObjectValues<global::GitHubKiota.Client.Models.Import_project_choices>(global::GitHubKiota.Client.Models.Import_project_choices.CreateFromDiscriminatorValue)?.AsList(); } },
                { "push_percent", n => { PushPercent = n.GetIntValue(); } },
                { "repository_url", n => { RepositoryUrl = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::GitHubKiota.Client.Models.Import_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::GitHubKiota.Client.Models.Import_project_choices>("project_choices", ProjectChoices);
            writer.WriteIntValue("push_percent", PushPercent);
            writer.WriteStringValue("repository_url", RepositoryUrl);
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.Import_status>("status", Status);
