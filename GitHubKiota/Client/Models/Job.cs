...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.Job_conclusion? Conclusion { get; set; }
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.Job_status? Status { get; set; }
        /// <summary>Steps in this job.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHubKiota.Client.Models.Job_steps>? Steps { get; set; }
#nullable restore
#else
        public List<global::GitHubKiota.Client.Models.Job_steps> Steps { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.Job"/> and sets the default values.
        /// </summary>
        public Job()
        {
        ...
        public static global::GitHubKiota.Client.Models.Job CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.Job();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "conclusion", n => { Conclusion = n.GetEnumValue<global::GitHubKiota.Client.Models.Job_conclusion>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::GitHubKiota.Client.Models.Job_status>(); } },
                { "steps", n => { Steps = n.GetCollectionOfObjectValues<global::GitHubKiota.Client.Models.Job_steps>(global::GitHubKiota.Client.Models.Job_steps.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.Job_conclusion>("conclusion", Conclusion);
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.Job_status>("status", Status);
            writer.WriteCollectionOfObjectValues<global::GitHubKiota.Client.Models.Job_steps>("steps", Steps);
