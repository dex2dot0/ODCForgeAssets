...
#nullable restore
        ...
        public global::GitHubKiota.Client.Models.CodespaceMachine_prebuild_availability? PrebuildAvailability { get; set; }
        /// <summary>How much storage is available to the codespace.</summary>
        public int? StorageInBytes { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Models.CodespaceMachine"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Models.CodespaceMachine"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Models.CodespaceMachine CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Models.CodespaceMachine();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "prebuild_availability", n => { PrebuildAvailability = n.GetEnumValue<global::GitHubKiota.Client.Models.CodespaceMachine_prebuild_availability>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Models.CodespaceMachine_prebuild_availability>("prebuild_availability", PrebuildAvailability);
