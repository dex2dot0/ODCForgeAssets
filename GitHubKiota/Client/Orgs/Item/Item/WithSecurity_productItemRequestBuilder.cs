...
using GitHubKiota.Client.Orgs.Item.Item.Item;
...
using System;
namespace GitHubKiota.Client.Orgs.Item.Item
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHubKiota.Client.orgs.item.item.item collection</summary>
        ...
        [Obsolete("")]
        public global::GitHubKiota.Client.Orgs.Item.Item.Item.WithEnablementItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("enablement", position);
                return new global::GitHubKiota.Client.Orgs.Item.Item.Item.WithEnablementItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Orgs.Item.Item.WithSecurity_productItemRequestBuilder"/> and sets the default values.
        /// </summary>
