...
#nullable restore
        ...
        public global::GitHubKiota.Client.Orgs.Item.Actions.RunnerGroups.RunnerGroupsPostRequestBody_visibility? Visibility { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Orgs.Item.Actions.RunnerGroups.RunnerGroupsPostRequestBody"/> and sets the default values.
        /// </summary>
        public RunnerGroupsPostRequestBody()
        {
            AdditionalData = new Dictionary<string, object>();
            Visibility = global::GitHubKiota.Client.Orgs.Item.Actions.RunnerGroups.RunnerGroupsPostRequestBody_visibility.All;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.Actions.RunnerGroups.RunnerGroupsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Orgs.Item.Actions.RunnerGroups.RunnerGroupsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Orgs.Item.Actions.RunnerGroups.RunnerGroupsPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "visibility", n => { Visibility = n.GetEnumValue<global::GitHubKiota.Client.Orgs.Item.Actions.RunnerGroups.RunnerGroupsPostRequestBody_visibility>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Orgs.Item.Actions.RunnerGroups.RunnerGroupsPostRequestBody_visibility>("visibility", Visibility);
