...
using System;
namespace GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.AlertsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::GitHubKiota.Client.Models.OrganizationSecretScanningAlert&gt;</returns>
...
#nullable enable
        public async Task<List<global::GitHubKiota.Client.Models.OrganizationSecretScanningAlert>?> GetAsync(Action<RequestConfiguration<global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHubKiota.Client.Models.OrganizationSecretScanningAlert>> GetAsync(Action<RequestConfiguration<global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHubKiota.Client.Models.OrganizationSecretScanningAlert>(requestInfo, global::GitHubKiota.Client.Models.OrganizationSecretScanningAlert.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.AlertsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.AlertsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.AlertsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists secret scanning alerts for eligible repositories in an organization, from newest to oldest.The authenticated user must be an administrator or security manager for the organization to use this endpoint.OAuth app tokens and personal access tokens (classic) need the `repo` or `security_events` scope to use this endpoint. If this endpoint is only used with public repositories, the token can use the `public_repo` scope instead.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>The direction to sort the results by.</summary>
            [QueryParameter("direction")]
            public global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.GetDirectionQueryParameterType? DirectionAsGetDirectionQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The property to sort the results by. `created` means when the alert was created. `updated` means when the alert was updated or resolved.</summary>
            [QueryParameter("sort")]
            public global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Set to `open` or `resolved` to only list secret scanning alerts in a specific state.</summary>
            [QueryParameter("state")]
            public global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.GetStateQueryParameterType? StateAsGetStateQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AlertsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHubKiota.Client.Orgs.Item.SecretScanning.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>
        {
        }
    }
}
