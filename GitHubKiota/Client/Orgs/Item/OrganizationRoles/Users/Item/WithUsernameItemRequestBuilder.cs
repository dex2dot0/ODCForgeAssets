...
using GitHubKiota.Client.Orgs.Item.OrganizationRoles.Users.Item.Item;
...
using System;
namespace GitHubKiota.Client.Orgs.Item.OrganizationRoles.Users.Item
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHubKiota.Client.orgs.item.organizationRoles.users.item.item collection</summary>
        /// <param name="position">The unique identifier of the role.</param>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.OrganizationRoles.Users.Item.Item.WithRole_ItemRequestBuilder"/></returns>
        public global::GitHubKiota.Client.Orgs.Item.OrganizationRoles.Users.Item.Item.WithRole_ItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("role_id", position);
                return new global::GitHubKiota.Client.Orgs.Item.OrganizationRoles.Users.Item.Item.WithRole_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the GitHubKiota.Client.orgs.item.organizationRoles.users.item.item collection</summary>
        /// <param name="position">The unique identifier of the role.</param>
        ...
        public global::GitHubKiota.Client.Orgs.Item.OrganizationRoles.Users.Item.Item.WithRole_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Orgs.Item.OrganizationRoles.Users.Item.WithUsernameItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.OrganizationRoles.Users.Item.WithUsernameItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHubKiota.Client.Orgs.Item.OrganizationRoles.Users.Item.WithUsernameItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHubKiota.Client.Orgs.Item.OrganizationRoles.Users.Item.WithUsernameItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
