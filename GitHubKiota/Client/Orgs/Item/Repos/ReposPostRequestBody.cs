...
using System.IO;
using System;
namespace GitHubKiota.Client.Orgs.Item.Repos
{
...
#nullable enable
        public global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_custom_properties? CustomProperties { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_custom_properties CustomProperties { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_merge_commit_message? MergeCommitMessage { get; set; }
        ...
        public global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_merge_commit_title? MergeCommitTitle { get; set; }
...
#nullable restore
        ...
        public global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_squash_merge_commit_message? SquashMergeCommitMessage { get; set; }
        ...
        public global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_squash_merge_commit_title? SquashMergeCommitTitle { get; set; }
        ...
        public global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_visibility? Visibility { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "custom_properties", n => { CustomProperties = n.GetObjectValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_custom_properties>(global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_custom_properties.CreateFromDiscriminatorValue); } },
                ...
                { "merge_commit_message", n => { MergeCommitMessage = n.GetEnumValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_merge_commit_message>(); } },
                { "merge_commit_title", n => { MergeCommitTitle = n.GetEnumValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_merge_commit_title>(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "private", n => { Private = n.GetBoolValue(); } },
                { "squash_merge_commit_message", n => { SquashMergeCommitMessage = n.GetEnumValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_squash_merge_commit_message>(); } },
                { "squash_merge_commit_title", n => { SquashMergeCommitTitle = n.GetEnumValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_squash_merge_commit_title>(); } },
                { "team_id", n => { TeamId = n.GetIntValue(); } },
                { "use_squash_pr_title_as_default", n => { UseSquashPrTitleAsDefault = n.GetBoolValue(); } },
                { "visibility", n => { Visibility = n.GetEnumValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_visibility>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_custom_properties>("custom_properties", CustomProperties);
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_merge_commit_message>("merge_commit_message", MergeCommitMessage);
            writer.WriteEnumValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_merge_commit_title>("merge_commit_title", MergeCommitTitle);
            writer.WriteStringValue("name", Name);
            writer.WriteBoolValue("private", Private);
            writer.WriteEnumValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_squash_merge_commit_message>("squash_merge_commit_message", SquashMergeCommitMessage);
            writer.WriteEnumValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_squash_merge_commit_title>("squash_merge_commit_title", SquashMergeCommitTitle);
            writer.WriteIntValue("team_id", TeamId);
            writer.WriteBoolValue("use_squash_pr_title_as_default", UseSquashPrTitleAsDefault);
            writer.WriteEnumValue<global::GitHubKiota.Client.Orgs.Item.Repos.ReposPostRequestBody_visibility>("visibility", Visibility);
