...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.Campaigns.Item.WithCampaign_numberPatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Orgs.Item.Campaigns.Item.WithCampaign_numberPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Orgs.Item.Campaigns.Item.WithCampaign_numberPatchRequestBody();
        }
        /// <summary>
