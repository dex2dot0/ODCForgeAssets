...
using System;
namespace GitHubKiota.Client.Orgs.Item.Hooks.Item.Config
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Orgs.Item.Hooks.Item.Config.ConfigRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHubKiota.Client.Models.WebhookConfig?> PatchAsync(global::GitHubKiota.Client.Orgs.Item.Hooks.Item.Config.ConfigPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHubKiota.Client.Models.WebhookConfig> PatchAsync(global::GitHubKiota.Client.Orgs.Item.Hooks.Item.Config.ConfigPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::GitHubKiota.Client.Orgs.Item.Hooks.Item.Config.ConfigPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::GitHubKiota.Client.Orgs.Item.Hooks.Item.Config.ConfigPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.Hooks.Item.Config.ConfigRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHubKiota.Client.Orgs.Item.Hooks.Item.Config.ConfigRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHubKiota.Client.Orgs.Item.Hooks.Item.Config.ConfigRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
