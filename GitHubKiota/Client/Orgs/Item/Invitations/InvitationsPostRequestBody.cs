...
#nullable restore
        ...
        public global::GitHubKiota.Client.Orgs.Item.Invitations.InvitationsPostRequestBody_role? Role { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Orgs.Item.Invitations.InvitationsPostRequestBody"/> and sets the default values.
        /// </summary>
        public InvitationsPostRequestBody()
        {
            AdditionalData = new Dictionary<string, object>();
            Role = global::GitHubKiota.Client.Orgs.Item.Invitations.InvitationsPostRequestBody_role.Direct_member;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.Invitations.InvitationsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Orgs.Item.Invitations.InvitationsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Orgs.Item.Invitations.InvitationsPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "role", n => { Role = n.GetEnumValue<global::GitHubKiota.Client.Orgs.Item.Invitations.InvitationsPostRequestBody_role>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Orgs.Item.Invitations.InvitationsPostRequestBody_role>("role", Role);
