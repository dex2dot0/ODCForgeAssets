...
using System;
namespace GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteResponse"/></returns>
...
#nullable restore
        ...
        public async Task<global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteResponse> DeleteAsSelected_teamsDeleteResponseAsync(global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteResponse>(requestInfo, global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// &gt; [!NOTE]&gt; This endpoint is in public preview and is subject to change.Sets seats for all members of each team specified to &quot;pending cancellation&quot;.This will cause the members of the specified team(s) to lose access to GitHub Copilot at the end of the current billing cycle unless they retain access through another team.For more information about disabling access to Copilot, see &quot;[Revoking access to Copilot for members of your organization](https://docs.github.com/copilot/managing-copilot/managing-github-copilot-in-your-organization/managing-access-to-github-copilot-in-your-organization/revoking-access-to-copilot-for-members-of-your-organization).&quot;Only organization owners can cancel Copilot seats for their organization members.The response contains the total number of seats set to &quot;pending cancellation&quot;.OAuth app tokens and personal access tokens (classic) need either the `manage_billing:copilot` or `admin:org` scopes to use this endpoint.
        /// API method documentation <see href="https://docs.github.com/rest/copilot/copilot-user-management#remove-teams-from-the-copilot-subscription-for-an-organization" />
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsResponse"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::GitHubKiota.Client.Models.BasicError">When receiving a 401 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsResponse?> DeleteAsync(global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsResponse> DeleteAsync(global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostResponse"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::GitHubKiota.Client.Models.BasicError">When receiving a 401 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostResponse?> PostAsSelected_teamsPostResponseAsync(global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostResponse> PostAsSelected_teamsPostResponseAsync(global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHubKiota.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
