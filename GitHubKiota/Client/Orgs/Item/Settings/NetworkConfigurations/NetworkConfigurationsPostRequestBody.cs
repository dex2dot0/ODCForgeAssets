...
namespace GitHubKiota.Client.Orgs.Item.Settings.NetworkConfigurations
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::GitHubKiota.Client.Orgs.Item.Settings.NetworkConfigurations.NetworkConfigurationsPostRequestBody_compute_service? ComputeService { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Orgs.Item.Settings.NetworkConfigurations.NetworkConfigurationsPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Orgs.Item.Settings.NetworkConfigurations.NetworkConfigurationsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Orgs.Item.Settings.NetworkConfigurations.NetworkConfigurationsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Orgs.Item.Settings.NetworkConfigurations.NetworkConfigurationsPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "compute_service", n => { ComputeService = n.GetEnumValue<global::GitHubKiota.Client.Orgs.Item.Settings.NetworkConfigurations.NetworkConfigurationsPostRequestBody_compute_service>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Orgs.Item.Settings.NetworkConfigurations.NetworkConfigurationsPostRequestBody_compute_service>("compute_service", ComputeService);
