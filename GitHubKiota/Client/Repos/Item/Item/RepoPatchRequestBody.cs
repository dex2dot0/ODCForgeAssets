...
#nullable restore
        ...
        public global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_merge_commit_message? MergeCommitMessage { get; set; }
        ...
        public global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_merge_commit_title? MergeCommitTitle { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_security_and_analysis? SecurityAndAnalysis { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_security_and_analysis SecurityAndAnalysis { get; set; }
#endif
        ...
        public global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_squash_merge_commit_message? SquashMergeCommitMessage { get; set; }
        ...
        public global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_squash_merge_commit_title? SquashMergeCommitTitle { get; set; }
        ...
        public global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_visibility? Visibility { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "merge_commit_message", n => { MergeCommitMessage = n.GetEnumValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_merge_commit_message>(); } },
                { "merge_commit_title", n => { MergeCommitTitle = n.GetEnumValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_merge_commit_title>(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "private", n => { Private = n.GetBoolValue(); } },
                { "security_and_analysis", n => { SecurityAndAnalysis = n.GetObjectValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_security_and_analysis>(global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_security_and_analysis.CreateFromDiscriminatorValue); } },
                { "squash_merge_commit_message", n => { SquashMergeCommitMessage = n.GetEnumValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_squash_merge_commit_message>(); } },
                { "squash_merge_commit_title", n => { SquashMergeCommitTitle = n.GetEnumValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_squash_merge_commit_title>(); } },
                { "use_squash_pr_title_as_default", n => { UseSquashPrTitleAsDefault = n.GetBoolValue(); } },
                { "visibility", n => { Visibility = n.GetEnumValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_visibility>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_merge_commit_message>("merge_commit_message", MergeCommitMessage);
            writer.WriteEnumValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_merge_commit_title>("merge_commit_title", MergeCommitTitle);
            writer.WriteStringValue("name", Name);
            writer.WriteBoolValue("private", Private);
            writer.WriteObjectValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_security_and_analysis>("security_and_analysis", SecurityAndAnalysis);
            writer.WriteEnumValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_squash_merge_commit_message>("squash_merge_commit_message", SquashMergeCommitMessage);
            writer.WriteEnumValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_squash_merge_commit_title>("squash_merge_commit_title", SquashMergeCommitTitle);
            writer.WriteBoolValue("use_squash_pr_title_as_default", UseSquashPrTitleAsDefault);
            writer.WriteEnumValue<global::GitHubKiota.Client.Repos.Item.Item.RepoPatchRequestBody_visibility>("visibility", Visibility);
