...
#nullable restore
        ...
        public global::GitHubKiota.Client.Repos.Item.Item.Releases.ReleasesPostRequestBody_make_latest? MakeLatest { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Repos.Item.Item.Releases.ReleasesPostRequestBody"/> and sets the default values.
        /// </summary>
        public ReleasesPostRequestBody()
        {
            AdditionalData = new Dictionary<string, object>();
            MakeLatest = global::GitHubKiota.Client.Repos.Item.Item.Releases.ReleasesPostRequestBody_make_latest.True;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Repos.Item.Item.Releases.ReleasesPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Repos.Item.Item.Releases.ReleasesPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Repos.Item.Item.Releases.ReleasesPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "make_latest", n => { MakeLatest = n.GetEnumValue<global::GitHubKiota.Client.Repos.Item.Item.Releases.ReleasesPostRequestBody_make_latest>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHubKiota.Client.Repos.Item.Item.Releases.ReleasesPostRequestBody_make_latest>("make_latest", MakeLatest);
