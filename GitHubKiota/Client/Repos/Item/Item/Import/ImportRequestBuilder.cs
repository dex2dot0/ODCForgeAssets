...
using GitHubKiota.Client.Repos.Item.Item.Import.Authors;
using GitHubKiota.Client.Repos.Item.Item.Import.Large_files;
using GitHubKiota.Client.Repos.Item.Item.Import.Lfs;
...
using System;
namespace GitHubKiota.Client.Repos.Item.Item.Import
{
    /// <summary>
    ...
    public partial class ImportRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::GitHubKiota.Client.Repos.Item.Item.Import.Authors.AuthorsRequestBuilder Authors
        {
            get => new global::GitHubKiota.Client.Repos.Item.Item.Import.Authors.AuthorsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The large_files property</summary>
        [Obsolete("")]
        public global::GitHubKiota.Client.Repos.Item.Item.Import.Large_files.Large_filesRequestBuilder Large_files
        {
            get => new global::GitHubKiota.Client.Repos.Item.Item.Import.Large_files.Large_filesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The lfs property</summary>
        [Obsolete("")]
        public global::GitHubKiota.Client.Repos.Item.Item.Import.Lfs.LfsRequestBuilder Lfs
        {
            get => new global::GitHubKiota.Client.Repos.Item.Item.Import.Lfs.LfsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Repos.Item.Item.Import.ImportRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Models.Import"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHubKiota.Client.Models.Import?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHubKiota.Client.Models.Import> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHubKiota.Client.Models.Import>(requestInfo, global::GitHubKiota.Client.Models.Import.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHubKiota.Client.Models.Import?> PatchAsync(global::GitHubKiota.Client.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHubKiota.Client.Models.Import> PatchAsync(global::GitHubKiota.Client.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHubKiota.Client.Models.Import?> PutAsync(global::GitHubKiota.Client.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHubKiota.Client.Models.Import> PutAsync(global::GitHubKiota.Client.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::GitHubKiota.Client.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::GitHubKiota.Client.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::GitHubKiota.Client.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::GitHubKiota.Client.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Repos.Item.Item.Import.ImportRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::GitHubKiota.Client.Repos.Item.Item.Import.ImportRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHubKiota.Client.Repos.Item.Item.Import.ImportRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
