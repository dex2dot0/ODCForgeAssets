...
using GitHubKiota.Client.Repos.Item.Item.DependencyGraph.Compare.Item;
...
using System;
namespace GitHubKiota.Client.Repos.Item.Item.DependencyGraph.Compare
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHubKiota.Client.repos.item.item.dependencyGraph.compare.item collection</summary>
        ...
        public global::GitHubKiota.Client.Repos.Item.Item.DependencyGraph.Compare.Item.WithBaseheadItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("basehead", position);
                return new global::GitHubKiota.Client.Repos.Item.Item.DependencyGraph.Compare.Item.WithBaseheadItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Repos.Item.Item.DependencyGraph.Compare.CompareRequestBuilder"/> and sets the default values.
        /// </summary>
