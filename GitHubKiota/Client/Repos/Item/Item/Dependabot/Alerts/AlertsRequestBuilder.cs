...
using GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.Item;
...
using System;
namespace GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHubKiota.Client.repos.item.item.dependabot.alerts.item collection</summary>
        ...
        /// <returns>A <see cref="global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.Item.WithAlert_numberItemRequestBuilder"/></returns>
        public global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.Item.WithAlert_numberItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("alert_number", position);
                return new global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.Item.WithAlert_numberItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the GitHubKiota.Client.repos.item.item.dependabot.alerts.item collection</summary>
        /// <param name="position">The number that identifies a Dependabot alert in its repository.You can find this at the end of the URL for a Dependabot alert within GitHub,or in `number` fields in the response from the`GET /repos/{owner}/{repo}/dependabot/alerts` operation.</param>
        ...
        public global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.Item.WithAlert_numberItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.AlertsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::GitHubKiota.Client.Models.DependabotAlert&gt;</returns>
...
#nullable enable
        public async Task<List<global::GitHubKiota.Client.Models.DependabotAlert>?> GetAsync(Action<RequestConfiguration<global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHubKiota.Client.Models.DependabotAlert>> GetAsync(Action<RequestConfiguration<global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHubKiota.Client.Models.DependabotAlert>(requestInfo, global::GitHubKiota.Client.Models.DependabotAlert.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.AlertsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.AlertsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.AlertsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// OAuth app tokens and personal access tokens (classic) need the `security_events` scope to use this endpoint. If this endpoint is only used with public repositories, the token can use the `public_repo` scope instead.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>The direction to sort the results by.</summary>
            [QueryParameter("direction")]
            public global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.GetDirectionQueryParameterType? DirectionAsGetDirectionQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The scope of the vulnerable dependency. If specified, only alerts with this scope will be returned.</summary>
            [QueryParameter("scope")]
            public global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.GetScopeQueryParameterType? ScopeAsGetScopeQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The property by which to sort the results.`created` means when the alert was created.`updated` means when the alert&apos;s state last changed.`epss_percentage` sorts alerts by the Exploit Prediction Scoring System (EPSS) percentage.</summary>
            [QueryParameter("sort")]
            public global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AlertsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHubKiota.Client.Repos.Item.Item.Dependabot.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>
        {
        }
    }
}
