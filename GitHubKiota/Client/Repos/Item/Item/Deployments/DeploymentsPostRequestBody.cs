...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody_payload? Payload { get; set; }
#nullable restore
#else
        public global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody_payload Payload { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "payload", n => { Payload = n.GetObjectValue<global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody_payload>(global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody_payload.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody_payload>("payload", Payload);
