...
using GitHubKiota.Client.Repos.Item.Item.Deployments.Item;
...
using System;
namespace GitHubKiota.Client.Repos.Item.Item.Deployments
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHubKiota.Client.repos.item.item.deployments.item collection</summary>
        /// <param name="position">deployment_id parameter</param>
        /// <returns>A <see cref="global::GitHubKiota.Client.Repos.Item.Item.Deployments.Item.WithDeployment_ItemRequestBuilder"/></returns>
        public global::GitHubKiota.Client.Repos.Item.Item.Deployments.Item.WithDeployment_ItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("deployment_id", position);
                return new global::GitHubKiota.Client.Repos.Item.Item.Deployments.Item.WithDeployment_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the GitHubKiota.Client.repos.item.item.deployments.item collection</summary>
        /// <param name="position">deployment_id parameter</param>
        ...
        public global::GitHubKiota.Client.Repos.Item.Item.Deployments.Item.WithDeployment_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::GitHubKiota.Client.Models.Deployment&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::GitHubKiota.Client.Models.Deployment>?> GetAsync(Action<RequestConfiguration<global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsRequestBuilder.DeploymentsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHubKiota.Client.Models.Deployment>> GetAsync(Action<RequestConfiguration<global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsRequestBuilder.DeploymentsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHubKiota.Client.Models.Deployment>(requestInfo, global::GitHubKiota.Client.Models.Deployment.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Models.Deployment"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHubKiota.Client.Models.Deployment?> PostAsync(global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHubKiota.Client.Models.Deployment> PostAsync(global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHubKiota.Client.Models.Deployment>(requestInfo, global::GitHubKiota.Client.Models.Deployment.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Simple filtering of deployments is available via query parameters:
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsRequestBuilder.DeploymentsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsRequestBuilder.DeploymentsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Simple filtering of deployments is available via query parameters:
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class DeploymentsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHubKiota.Client.Repos.Item.Item.Deployments.DeploymentsRequestBuilder.DeploymentsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
