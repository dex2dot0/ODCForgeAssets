...
using GitHubKiota.Client.Advisories.Item;
...
using System;
namespace GitHubKiota.Client.Advisories
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHubKiota.Client.advisories.item collection</summary>
        /// <param name="position">The GHSA (GitHub Security Advisory) identifier of the advisory.</param>
        /// <returns>A <see cref="global::GitHubKiota.Client.Advisories.Item.WithGhsa_ItemRequestBuilder"/></returns>
        public global::GitHubKiota.Client.Advisories.Item.WithGhsa_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("ghsa_id", position);
                return new global::GitHubKiota.Client.Advisories.Item.WithGhsa_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHubKiota.Client.Advisories.AdvisoriesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::GitHubKiota.Client.Models.GlobalAdvisory&gt;</returns>
        ...
        /// <exception cref="global::GitHubKiota.Client.Models.BasicError">When receiving a 429 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::GitHubKiota.Client.Models.GlobalAdvisory>?> GetAsync(Action<RequestConfiguration<global::GitHubKiota.Client.Advisories.AdvisoriesRequestBuilder.AdvisoriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHubKiota.Client.Models.GlobalAdvisory>> GetAsync(Action<RequestConfiguration<global::GitHubKiota.Client.Advisories.AdvisoriesRequestBuilder.AdvisoriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "429", global::GitHubKiota.Client.Models.BasicError.CreateFromDiscriminatorValue },
            };
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHubKiota.Client.Models.GlobalAdvisory>(requestInfo, global::GitHubKiota.Client.Models.GlobalAdvisory.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHubKiota.Client.Advisories.AdvisoriesRequestBuilder.AdvisoriesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHubKiota.Client.Advisories.AdvisoriesRequestBuilder.AdvisoriesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHubKiota.Client.Advisories.AdvisoriesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHubKiota.Client.Advisories.AdvisoriesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHubKiota.Client.Advisories.AdvisoriesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists all global security advisories that match the specified parameters. If no other parameters are defined, the request will return only GitHub-reviewed advisories that are not malware.By default, all responses will exclude advisories for malware, because malware are not standard vulnerabilities. To list advisories for malware, you must include the `type` parameter in your request, with the value `malware`. For more information about the different types of security advisories, see &quot;[About the GitHub Advisory database](https://docs.github.com/code-security/security-advisories/global-security-advisories/about-the-github-advisory-database#about-types-of-security-advisories).&quot;
        /// </summary>
...
#nullable restore
            ...
            /// <summary>The direction to sort the results by.</summary>
            [QueryParameter("direction")]
            public global::GitHubKiota.Client.Advisories.GetDirectionQueryParameterType? DirectionAsGetDirectionQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>If specified, only advisories for these ecosystems will be returned.</summary>
            [QueryParameter("ecosystem")]
            public global::GitHubKiota.Client.Models.SecurityAdvisoryEcosystems? EcosystemAsSecurityAdvisoryEcosystems { get; set; }
...
#nullable restore
            ...
            /// <summary>If specified, only advisories with these severities will be returned.</summary>
            [QueryParameter("severity")]
            public global::GitHubKiota.Client.Advisories.GetSeverityQueryParameterType? SeverityAsGetSeverityQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The property to sort the results by.</summary>
            [QueryParameter("sort")]
            public global::GitHubKiota.Client.Advisories.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>If specified, only advisories of this type will be returned. By default, a request with no other parameters defined will only return reviewed advisories that are not malware.</summary>
            [QueryParameter("type")]
            public global::GitHubKiota.Client.Advisories.GetTypeQueryParameterType? TypeAsGetTypeQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AdvisoriesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHubKiota.Client.Advisories.AdvisoriesRequestBuilder.AdvisoriesRequestBuilderGetQueryParameters>
        {
        }
    }
}
