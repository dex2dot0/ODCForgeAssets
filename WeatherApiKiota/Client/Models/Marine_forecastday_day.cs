...
#nullable enable
        public global::WeatherApiKiota.Client.Models.Marine_forecastday_day_condition? Condition { get; set; }
#nullable restore
#else
        public global::WeatherApiKiota.Client.Models.Marine_forecastday_day_condition Condition { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::WeatherApiKiota.Client.Models.Marine_forecastday_day"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::WeatherApiKiota.Client.Models.Marine_forecastday_day"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::WeatherApiKiota.Client.Models.Marine_forecastday_day CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::WeatherApiKiota.Client.Models.Marine_forecastday_day();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "condition", n => { Condition = n.GetObjectValue<global::WeatherApiKiota.Client.Models.Marine_forecastday_day_condition>(global::WeatherApiKiota.Client.Models.Marine_forecastday_day_condition.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::WeatherApiKiota.Client.Models.Marine_forecastday_day_condition>("condition", Condition);
